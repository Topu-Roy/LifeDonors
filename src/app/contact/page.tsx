...
export default function page() {
  return (
    <div className="min-h-[85dvh] w-full bg-gray-100 py-8">
      <div className="flex h-full min-h-[80dvh] items-center justify-center">
        <div className="mx-auto grid h-full max-w-7xl grid-cols-1 gap-8 px-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="col-span-2 h-full rounded-lg bg-white p-6 shadow-lg md:col-span-1 lg:col-span-2">
            ...
            <p className="mb-6 text-gray-600">
              ...
              Whether you&apos;re looking to donate blood, need assistance
              finding a donor, or want to learn more about our services,
          ...
          <div className="col-span-2 flex w-full flex-col items-start justify-between rounded-lg bg-white p-6 shadow-lg md:col-span-1">
            <div className="">
              ...
              <p className="mb-6 text-gray-600">
                LifeDonors is dedicated to revolutionizing the way people
                connect for blood donation. Our service is designed to be fast,
                reliable, and accessible to everyone, making it easier than ever
                to donate blood or find a donor in critical times.
              </p>
            </div>
